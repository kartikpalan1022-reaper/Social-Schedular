...
const AIComposer = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-21 pb-20 animate-in fade-in duration-700">
      {/* Input section */}
          ...
          <div className="bg-white rounded-xl shadow-2xl w-full max-w-2xl border border-slate-100 overflow:hidden flex flex-col max-h-[90vh]">
            ...
            <div className="p-8 bg-slate-50/50 border-t border-slate-50 space-y-8">
              ...
              <div className="space-y-6">
                <div>
                  <label className="block text-xs text-slate-600 uppercase tracking-widest mb-4">Selected Channels</label>
